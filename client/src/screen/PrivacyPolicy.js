    ...
    <SafeAreaView style={{ flex: 1 }}>
      <ScrollView style={{ flex: 1 }}>
        <View style={{ padding: 20 }}>
          <Text style={style.textHeader}>Pinwheel > Privacy Policy</Text>
          <Text style={style.text}>
            {" "}
            Oceansmall built the Pinwheel app as a Free app. This SERVICE is
            provided by Oceansmall at no cost and is intended for use as is.
          ...
          <Text style={style.text}>
            ...
            our Terms and Conditions, which are accessible at Pinwheel unless
          ...
          <Text style={style.text}>
            ...
            may not be able to use some portions of this Service. Service
            Providers We may employ third-party companies and individuals due to
            ...
            <Text style={style.text}>
              ...
              any third-party sites or services. Children’s Privacy These
              ...
              do the necessary actions. Changes to This Privacy Policy We may
              ...
              This policy is effective as of 2022-05-15 Contact Us If you have
              any questions or suggestions about our Privacy Policy, do not
              hesitate to contact us at
            </Text>
            <Text style={{ fontSize: 16, fontWeight: "bold" }}>
              admin@oceansmall.com.
            </Text>
          <View>
            <Text style={style.textHeader}>Pinwheel > Terms of Use</Text>
            <Text style={style.text}>
              ...
              property rights related to it, still belong to Oceansmall.
            </Text>
            <Text style={style.text}>
              Oceansmall is committed to ensuring that the app is as useful and
            ...
            <Text style={style.text}>
              The Pinwheel app stores and processes personal data that you have
              ...
              the Pinwheel app won’t work properly or at all.
            </Text>
            <Text style={style.text}>
              You should be aware that there are certain things that Oceansmall
              ...
              provider, but Oceansmall cannot take responsibility for the app
            ...
            <Text style={style.text}>
              Along the same lines, Oceansmall cannot always take responsibility
              ...
              turn it on to avail the Service, Oceansmall cannot accept
              responsibility.
            </Text>
            <Text style={style.text}>
              With respect to Oceansmall’s responsibility for your use of the
              ...
              to us so that we can make it available to you. Oceansmall accepts
            ...
            <Text style={style.text}>
              ...
              want to keep using the app. Oceansmall does not promise that it
            ...
            <Text style={style.text}>
              ...
              as of 2022-05-15 Contact Us If you have any questions or
              suggestions about our Terms and Conditions, do not hesitate to
              contact us at admin@oceansmall.com.
            </Text>
          </View>
        </View>
      </ScrollView>
